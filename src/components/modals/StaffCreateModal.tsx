...
export default function StaffCreateModal({ isOpen, onClose, onSuccess }: StaffCreateModalProps) {
  ...
  const getStepDescription = (step: number) => {
    switch (step) {
      case 1:
        return 'Enter the basic staff member information';
      case 2:
        return 'Create login credentials for the staff member';
      case 3:
        return 'Review all information before creating the staff member';
      default:
        return '';
    }
  };
