...
interface FuelStationCreateModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}
...
const FuelStationCreateModal: React.FC<FuelStationCreateModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await fuelStationService.createFuelStation(fuelStationData);
      showSuccessToast(`Fuel Station "${formData.name}" created successfully!`);
      setFormData({
        name: '',
        isActive: true,
        city: '',
      ...
      const errorMessage = error instanceof Error ? error.message : 'Failed to create fuel station';
...
export default FuelStationCreateModal;
